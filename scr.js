...
const successMessage = "Your message has been received. I appreciate your interest and potential opportunities.\n As a professional in the industry,\n I value your outreach. :)"
...
if (!NameResult) {
  ...
  if(NameResult && EmailResult && MessageResult){
    document.getElementById('exampleModalLabel').innerText = "Thank you for getting in touch!"
    document.getElementById('validationMessage').innerText
    = successMessage;
    $('#validationModal').modal('show');
  }
